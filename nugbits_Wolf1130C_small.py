...
def teffRM(theta,sigDist,sigPhot):
    ...
    #
    # # Wolf 1130C gases: [rh2o,rch4,rco,rco2,rnh3,rh2s,rph3]
    #
    # # We will base e
    # h2o = theta[0]
    # ch4 = theta[1]
    ...
    # ph3 = theta[6]
    #
    # # first get the C/O (will use all gases)
    #
    ...
    # # rest of the elements Eileen will here for Wolf1130C to compare to value
    # N = 10 ** nh3
    # S = 10 ** h2s
    # P = 10 ** ph3
    #
    # # Determine "fraction" of H2 in the T dwarf
    # gas_sum = 10**h2o + 10**co +10**co2 + 10**ch4 + 10**ph3 + 10**h2s + 10**nh3 #All gases
    ...
    result = np.concatenate((theta,np.array([l_bol, t_ff])),axis=0)
