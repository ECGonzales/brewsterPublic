...
gaslist = ['h2o','ch4','co','co2','nh3','h2s']
...
if (fresh == 0):
    ...
    p0[:,8] = np.random.randn(nwalkers).reshape(nwalkers) * 10.  # vrad
    p0[:,9] = 20. + (np.random.randn(nwalkers).reshape(nwalkers)*5.)  # vsini only for FWHM ==3
