...
import scipy as sp
import emcee
import testkit_m_05 as testkit
import ciamod
import TPmod
import settings
import os
...
if (fresh == 0):
    ...
    p0[:,7] = 0.1*np.random.randn(nwalkers).reshape(nwalkers) + 4.8  # gravity
...
#Checm Eq 3k ,metscale=[-1.  , -0.75, -0.7 , -0.5 , -0.3 , -0.25,  0.  ,  0.5 ,  0.7 ,1.  ,  1.5 ,  1.7 ,  2.  ], c/o=[0.25, 0.5 , 1.  , 1.5 , 2.  , 2.5 ] T=[75,4000]
#Chmeeq 500_6K met=[-2.5, -2. , -1.5, -1. , -0.5,  0. ,  0.5,  1. ,  1.5,  2. ,  2.5, 3. ]), c/o=[0.25, 0.5 , 1.  , 1.5 , 2.  , 2.5 ]
