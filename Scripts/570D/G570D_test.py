...
# Give the run name
runname = "G570D_test_NAS_9_20_24"
...
# give the full path
xpath = "/nobackupp27/egonza65/Linelists/"
...
outdir = "/nobackupp27/egonza65/Results/G570D/"
...
if (fresh == 0):
    ...
    p0[:,6] = r2d2 + (np.random.randn(nwalkers).reshape(nwalkers) * (0.1*r2d2))  # scale factor 1
